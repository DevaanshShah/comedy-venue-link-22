  ...
  const features = [
    {
      ...
      description: "Easy event scheduling and ticket management for venues and comedians"
    },
    {
      icon: Laugh,
      title: "Talent Discovery",
      description: "Find venues or comedians that match your style and preferences"
    },
    {
      icon: Mic,
      title: "Performance Analytics",
      description: "Track attendance, reviews, and engagement for your shows"
    },
    {
      icon: Ticket,
      title: "Ticketing System",
      description: "Simple payment processing and digital ticket delivery"
    }
  ];

  const testimonials = [
    {
      quote: "Comedy Link revolutionized how I find gigs and connect with venue owners.",
      author: "Sarah Johnson",
      role: "Stand-up Comedian"
    },
    {
      quote: "We've increased our comedy night attendance by 40% since joining the platform.",
      author: "Michael Rodriguez",
      role: "Venue Manager"
    },
    {
      quote: "I never miss a show now that I can easily find and book tickets through Comedy Link.",
      author: "David Chen",
      role: "Comedy Fan"
    }
  ];
          ...
          <div className="text-center max-w-3xl mx-auto">
            <AnimatedElement animation="slide-up" className="inline-block">
              <span className="bg-white/10 text-comedy-red px-4 py-2 rounded-full text-sm font-medium">
                The Ultimate Comedy Marketplace
              </span>
            </AnimatedElement>
            
            <AnimatedElement animation="slide-up" delay={200}>
              <h1 className="text-4xl md:text-6xl font-bold mt-6 mb-6 leading-tight">
                Where <span className="text-comedy-red">Comedy</span> Connects
              </h1>
            </AnimatedElement>
            
            <AnimatedElement animation="slide-up" delay={400}>
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Bringing together venues, comedians, and audiences to create unforgettable live comedy experiences.
              </p>
            </AnimatedElement>
        ...
        <div className="container mx-auto px-4">
          <AnimatedElement animation="slide-up" className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Everything you need to connect, perform, and enjoy live comedy.
            </p>
          </AnimatedElement>
      ...
      <section className="py-20 bg-comedy-dark">
        <div className="container mx-auto px-4">
          <AnimatedElement animation="slide-up" className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Discover the hottest comedy shows and secure your tickets today.
            </p>
          </AnimatedElement>
      ...
      <section className="py-20 bg-gradient-to-b from-comedy-darker to-comedy-dark">
        <div className="container mx-auto px-4">
          <AnimatedElement animation="slide-up" className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Join the growing community of satisfied comedy professionals and fans.
            </p>
          </AnimatedElement>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <AnimatedElement animation="slide-up">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Join the Comedy Revolution?</h2>
            </AnimatedElement>
            <AnimatedElement animation="slide-up" delay={200}>
              <p className="text-xl text-muted-foreground mb-8">
                Whether you're a venue owner, comedian, or comedy fan, we've got the tools you need to elevate your comedy experience.
              </p>
            </AnimatedElement>
